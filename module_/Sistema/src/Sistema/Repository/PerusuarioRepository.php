...
/**
 * PerusuarioRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class PerusuarioRepository extends EntityRepository {
	public function buscar($campos, $paginacion) {
		$qb = $this->_em->createQueryBuilder();
		$qb->select('pu')
		   ->from('Sistema\Entity\Perusuario', 'pu')
		   ->innerJoin('pu.persona', 'p')
		   ->where('pu.nperusuestado != :nperusuestado')
		   ->andWhere('p.nperestado = :nperestado')
		   ->orderBy('p.cpernombre', 'ASC')
		   ->setParameter('nperestado', 1)
		   ->setParameter('nperusuestado', 0);
