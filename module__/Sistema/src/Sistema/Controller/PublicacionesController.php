...
use Sistema\Form\PublicacionesForm;
use Zend\Mvc\Controller\AbstractActionController;
use Zend\Session\Container;
use Zend\View\Model\JsonModel;
use Zend\View\Model\ViewModel;

class PublicacionesController extends AbstractActionController {
	private $usuarioLogueado;
	private $nctrcodigo = 102;
	private $rutaRaiz = 'sistema/publicaciones';
	private $items = 1;
	private $em;
	private $emNamespace = 'Sistema\Entity\Publicaciones';
	private $repo;
	...
	public function inicioAction() {
		...
		$campos = array();
		$publicacioness = $this->repo->buscar($campos, $paginacion);
		...
		$view = new ViewModel();
		$view->setVariable('publicacioness', $publicacioness)
	...
	public function filtrarAction() {
		...
		$viewLista->setTemplate('sistema/publicaciones/lista.phtml')
		          ->setVariable('publicacioness', $publicacioness)
		          ->setTerminal(true);
	...
	public function editarAction() {
		...
		$publicaciones = $this->repo->find($id);

		$form = new PublicacionesForm($this->em);
		$form->bind($publicaciones);
