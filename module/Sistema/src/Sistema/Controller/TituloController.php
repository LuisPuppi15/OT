...
use Sistema\Form\TituloForm;
use Zend\Mvc\Controller\AbstractActionController;
use Zend\Session\Container;
use Zend\View\Model\JsonModel;
use Zend\View\Model\ViewModel;

class TituloController extends AbstractActionController {
	private $usuarioLogueado;
	private $nctrcodigo = 24;
	private $rutaRaiz = 'sistema/titulo';
	private $items = 1;
	private $em;
	private $emNamespace = 'Sistema\Entity\Titulo';
	private $repo;
	...
	public function inicioAction() {
		...
		$campos = array();
		$titulos = $this->repo->buscar($campos, $paginacion);
		...
		$view = new ViewModel();
		$view->setVariable('titulos', $titulos)
	...
	public function filtrarAction() {
		...
		$viewLista->setTemplate('sistema/titulo/lista.phtml')
		          ->setVariable('titulos', $titulos)
		          ->setTerminal(true);
	...
	public function editarAction() {
		...
		$titulo = $this->repo->find($id);

		$form = new TituloForm($this->em);
		$form->bind($titulo);
