 ...
 */
class NivelmenuRepository extends EntityRepository {
	...
	public function buscar($campos, $paginacion) {
		...
		$qb->select('nm')
		   ->from('Sistema\Entity\Nivelmenu', 'nm')
		   ->where('nm.nnivmenestado != :nnivmenestado')
		   ->orderBy('nm.cnivmennombre', 'ASC')
		   ->setParameter('nnivmenestado', 0);
