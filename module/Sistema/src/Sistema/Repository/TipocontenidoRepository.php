 ...
 */
class TipocontenidoRepository extends EntityRepository {
	...
	public function buscar($campos, $paginacion) {
		...
		$qb->select('tc')
		   ->from('Sistema\Entity\Tipocontenido', 'tc')
		   ->where('tc.ntipconestado != :ntipconestado')
		   ->orderBy('tc.ctipconnombre', 'ASC')
		   ->setParameter('ntipconestado', 0);
